...
namespace Lunatics.SDLGL
{
	public static class OpenGL
	{
		public enum ArrayCap
		{
			...
			FogCoordArray = 33879, // 0x00008457
			SecondaryColorArray = 33886, // 0x0000845E
		}
		...
		public static class GL
		{
			...
			public delegate void EnableClientStateDelegate(ArrayCap cap);
			public static EnableClientStateDelegate EnableClientState;

			[System.Security.SuppressUnmanagedCodeSecurity()]
			public delegate void DisableClientStateDelegate(ArrayCap cap);
			...
			[System.Security.SuppressUnmanagedCodeSecurity()]
			internal unsafe delegate void GetFloatDelegate(int param, [Out] float* data);
			internal static GetFloatDelegate GetFloatv;
			...
			[System.Security.SuppressUnmanagedCodeSecurity()]
			public delegate void DrawArraysDelegate(PrimitiveType primitiveType, int offset, int count);
			...
			[System.Security.SuppressUnmanagedCodeSecurity()]
			public delegate void ClientActiveTextureDelegate(TextureUnit textureUnit);
			public static ClientActiveTextureDelegate ClientActiveTexture;
			...
			[System.Security.SuppressUnmanagedCodeSecurity()]
			public delegate void BlendEquationSeparateDelegate(BlendEquationMode colorMode,
			...
			[System.Security.SuppressUnmanagedCodeSecurity()]
			public delegate void BlendFuncDelegate(BlendingFactorSrc colorSrc,
			                                       BlendingFactorDest colorDst);
			public static BlendFuncDelegate BlendFunc;

			[System.Security.SuppressUnmanagedCodeSecurity()]
			internal delegate void BlendFuncIDelegate(int buffer,
			                                          BlendingFactorSrc colorSrc,
			                                          BlendingFactorDest colorDst);
			internal static BlendFuncIDelegate BlendFuncI;
			...
			[System.Security.SuppressUnmanagedCodeSecurity()]
			public delegate void StencilFuncSeparateDelegate(StencilFace face,
			...
			[System.Security.SuppressUnmanagedCodeSecurity()]
			public delegate void StencilOpSeparateDelegate(StencilFace face,
			...
			[System.Security.SuppressUnmanagedCodeSecurity()]
			public delegate void StencilFuncDelegate(StencilFunction function, int referenceStencil, int mask);
			...
			[System.Security.SuppressUnmanagedCodeSecurity()]
			public delegate void CompressedTexImage2DDelegate(TextureTarget target,
			                                                  int level,
			...
			[System.Security.SuppressUnmanagedCodeSecurity()]
			public delegate void TexImage2DDelegate(TextureTarget target,
			                                        int level,
			                                        PixelInternalFormat internalFormat,
			                                        int width,
			                                        int height,
			...
			[System.Security.SuppressUnmanagedCodeSecurity()]
			public delegate void CompressedTexSubImage2DDelegate(TextureTarget target,
			                                                     int level,
			                                                     int x,
			                                                     int y,
			                                                     int width,
			...
			[System.Security.SuppressUnmanagedCodeSecurity()]
			public delegate void TexSubImage2DDelegate(TextureTarget target,
			                                             int level,
			                                             int x,
			                                             int y,
			                                             int width,
			...
			public delegate void GetBufferSubDataDelegate(BufferTarget target, IntPtr offset, IntPtr size, IntPtr data);
			public static GetBufferSubDataDelegate GetBufferSubData;
			...
			[System.Security.SuppressUnmanagedCodeSecurity()]
			public delegate void VertexAttribPointerDelegate(int location,
			                                                   int elementCount,
			...
			[System.Security.SuppressUnmanagedCodeSecurity()]
			public delegate void ColorMaskIDelegate(uint buf, bool red, bool green, bool blue, bool alpha);
			public static ColorMaskIDelegate ColorMaskI;

			[UnmanagedFunctionPointer(CallingConvention.StdCall)]
			public delegate void SampleMaskIDelegate(uint maskNumber, uint mask);
			public static SampleMaskIDelegate SampleMaskI;

			[UnmanagedFunctionPointer(CallingConvention.StdCall)]
			internal delegate void DrawRangeElementsDelegate(PrimitiveType mode,
			                                                 int start,
			                                                 int end,
			                                                 int count,
			...
			[UnmanagedFunctionPointer(CallingConvention.StdCall)]
			public delegate void DrawRangeElementsBaseVertexDelegate(PrimitiveType mode,
			                                                         int start,
			                                                         int end,
			                                                         int count,
			                                                         DrawElementsType type,
			                                                         IntPtr indices,
			                                                         int baseVertex);
			public static DrawRangeElementsBaseVertexDelegate DrawRangeElementsBaseVertex;

            [UnmanagedFunctionPointer(CallingConvention.StdCall)]
            public delegate void GenVertexArraysDelegate(int n, out int arrays);
            public static GenVertexArraysDelegate GenVertexArrays;

            [UnmanagedFunctionPointer(CallingConvention.StdCall)]
            public delegate void DeleteVertexArraysDelegate(int n, ref int arrays);
            public static DeleteVertexArraysDelegate DeleteVertexArrays;

            [UnmanagedFunctionPointer(CallingConvention.StdCall)]
            public delegate void BindVertexArrayDelegate(int arrays);
			...
			public static unsafe void GetInteger(GetPName name, out int value)
			{
				fixed (int* ptr = &value)
				{
			...
			public static unsafe void GetInteger(GetPName name, int[] value)
			{
			...
			public static unsafe void GetInteger(int name, out int value)
			{
				fixed (int* ptr = &value)
				{
			...
			public static unsafe void GetFloat(GetPName name, out float value)
			{
			...
			public static unsafe void TexParameter(TextureTarget target, TextureParameterName name, float[] values)
			{
			...
			public static unsafe void GetShader(int shaderId, ShaderParameter name, out int result)
			{
			...
			public static unsafe void GetProgram(int programId, GetProgramParameterName name, out int result)
			{
				fixed (int* ptr = &result)
				{
			...
			public static unsafe void ShaderSource(int shaderId, string code)
			{
			...
			public static unsafe void UniformMatrix4(int location, int size, bool transpose, ref Matrix matrix)
			{
			...
			public static void LoadEntryPoints(bool useCoreProfile)
			{
				if (Viewport == null)
				...
				EnableClientState = LoadFunction<EnableClientStateDelegate>("glEnableClientState");
				DisableClientState = LoadFunction<DisableClientStateDelegate>("glDisableClientState");
				GetFloatv = LoadFunction<GetFloatDelegate>("glGetFloatv");
				BlendFunc = LoadFunction<BlendFuncDelegate>("glBlendFunc");
				BlendFuncI = LoadFunction<BlendFuncIDelegate>("glBlendFunci");
				ClientActiveTexture = LoadFunction<ClientActiveTextureDelegate>("glClientActiveTexture");
