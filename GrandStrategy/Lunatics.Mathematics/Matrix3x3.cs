...
namespace Lunatics.Mathematics
{
	...
	public struct Matrix3x3 : IEquatable<Matrix3x3>, IFormattable
	{
		...
		{
			return
				MathUtils.NearEqual(a.M11, b.M11) &&
				MathUtils.NearEqual(a.M12, b.M12) &&
				MathUtils.NearEqual(a.M13, b.M13) &&

				MathUtils.NearEqual(a.M21, b.M21) &&
				MathUtils.NearEqual(a.M22, b.M22) &&
				MathUtils.NearEqual(a.M23, b.M23) &&

				MathUtils.NearEqual(a.M31, b.M31) &&
				MathUtils.NearEqual(a.M32, b.M32) &&
				MathUtils.NearEqual(a.M33, b.M33)
				;
		}
