...
namespace Lunatics.Mathematics
{
	...
	public struct Matrix : IEquatable<Matrix>, IFormattable
	{
		...
		/// </summary>
		public static readonly Matrix Zero = new Matrix(0.0f);
		...
		public bool Decompose(out Vector3 scale, out Quaternion rotation, out Vector3 translation)
		{
			...
			if (MathUtils.IsZero(scale.X) ||
				MathUtils.IsZero(scale.Y) ||
				MathUtils.IsZero(scale.Z))
			{
		...
		public bool DecomposeUniformScale(out float scale, out Quaternion rotation, out Vector3 translation)
		{
			...
			if (Math.Abs(scale) < MathUtils.ZeroTolerance)
			{
				rotation = Quaternion.Identity;
				return false;
			}
		...
		public static void UpperTriangularForm(ref Matrix value, out Matrix result)
		{
			...
			for (int r = 0; r < rowcount; ++r)
			{
				...
				while (MathUtils.IsZero(result[i, lead]))
				{
					i++;
