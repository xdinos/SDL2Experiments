...
namespace Lunatics.Mathematics
{
	public static class MathUtils
	{
		...
		/// </summary>
		public const float PiOverTwo = (float)(Math.PI / 2.0);

		/// <summary>
		/// A value specifying the approximation of π/4 which is 45 degrees.
		/// </summary>
		public const float PiOverFour = (float)(Math.PI / 4.0);

		public static readonly float MachineEpsilonFloat = float.Epsilon;	// TODO: GetMachineEpsilonFloat();
