...
namespace Lunatics.Mathematics
{
	/// <summary>
	...
	public struct Matrix5x4 : IEquatable<Matrix5x4>, IFormattable
	{
		...
		/// </summary>
		public static readonly Matrix5x4 Zero = new Matrix5x4(0.0f);
				...
				switch (index)
				{
					...
					default:
						throw new ArgumentOutOfRangeException(
							nameof(index), "Indices for Matrix5x4 run from 0 to 19, inclusive.");
				}
			}
		}
		...
		{
			result.M11 = MathUtils.Lerp(start.M11, end.M11, amount);
			result.M12 = MathUtils.Lerp(start.M12, end.M12, amount);
			result.M13 = MathUtils.Lerp(start.M13, end.M13, amount);
			result.M14 = MathUtils.Lerp(start.M14, end.M14, amount);
			result.M21 = MathUtils.Lerp(start.M21, end.M21, amount);
			result.M22 = MathUtils.Lerp(start.M22, end.M22, amount);
			result.M23 = MathUtils.Lerp(start.M23, end.M23, amount);
			result.M24 = MathUtils.Lerp(start.M24, end.M24, amount);
			result.M31 = MathUtils.Lerp(start.M31, end.M31, amount);
			result.M32 = MathUtils.Lerp(start.M32, end.M32, amount);
			result.M33 = MathUtils.Lerp(start.M33, end.M33, amount);
			result.M34 = MathUtils.Lerp(start.M34, end.M34, amount);
			result.M41 = MathUtils.Lerp(start.M41, end.M41, amount);
			result.M42 = MathUtils.Lerp(start.M42, end.M42, amount);
			result.M43 = MathUtils.Lerp(start.M43, end.M43, amount);
			result.M44 = MathUtils.Lerp(start.M44, end.M44, amount);
			result.M51 = MathUtils.Lerp(start.M51, end.M51, amount);
			result.M52 = MathUtils.Lerp(start.M52, end.M52, amount);
			result.M53 = MathUtils.Lerp(start.M53, end.M53, amount);
			result.M54 = MathUtils.Lerp(start.M54, end.M54, amount);
		}
		...
		{
			amount = MathUtils.SmoothStep(amount);
		...
		public override string ToString()
		{
			return string.Format(CultureInfo.CurrentCulture,
			                     ...
			                     M11, M12, M13, M14, M21, M22, M23, M24, M31, M32, M33, M34, M41, M42, M43, M44, M51,
			                     M52, M53, M54);
		}
		...
		public string ToString(string format)
		{
			...
			return string.Format(format, CultureInfo.CurrentCulture,
			                     "[M11:{0} M12:{1} M13:{2} M14:{3}] [M21:{4} M22:{5} M3:{6} M24:{7}] [M31:{8} M32:{9} M33:{10} M34:{11}] [M41:{12} M42:{13} M43:{14} M44:{15}] [M51:{16} M52:{17} M53:{18} M54:{19}]",
			                     M11.ToString(format, CultureInfo.CurrentCulture),
			                     M12.ToString(format, CultureInfo.CurrentCulture),
			                     M13.ToString(format, CultureInfo.CurrentCulture),
			                     M14.ToString(format, CultureInfo.CurrentCulture),
			                     M21.ToString(format, CultureInfo.CurrentCulture),
			                     M22.ToString(format, CultureInfo.CurrentCulture),
			                     M23.ToString(format, CultureInfo.CurrentCulture),
			                     M24.ToString(format, CultureInfo.CurrentCulture),
			                     M31.ToString(format, CultureInfo.CurrentCulture),
			                     M32.ToString(format, CultureInfo.CurrentCulture),
			                     M33.ToString(format, CultureInfo.CurrentCulture),
			                     M34.ToString(format, CultureInfo.CurrentCulture),
			                     M41.ToString(format, CultureInfo.CurrentCulture),
			                     M42.ToString(format, CultureInfo.CurrentCulture),
			                     M43.ToString(format, CultureInfo.CurrentCulture),
			                     M44.ToString(format, CultureInfo.CurrentCulture),
			                     M51.ToString(format, CultureInfo.CurrentCulture),
			                     M52.ToString(format, CultureInfo.CurrentCulture),
			                     M53.ToString(format, CultureInfo.CurrentCulture),
			                     M54.ToString(format, CultureInfo.CurrentCulture));
		}
		...
		public string ToString(IFormatProvider formatProvider)
		{
			return string.Format(formatProvider,
			                     ...
			                     M13.ToString(formatProvider), M14.ToString(formatProvider),
			                     M21.ToString(formatProvider), M22.ToString(formatProvider),
			                     M23.ToString(formatProvider), M24.ToString(formatProvider),
			                     M31.ToString(formatProvider), M32.ToString(formatProvider),
			                     M33.ToString(formatProvider), M34.ToString(formatProvider),
			                     M41.ToString(formatProvider), M42.ToString(formatProvider),
			                     M43.ToString(formatProvider), M44.ToString(formatProvider),
			                     M51.ToString(formatProvider), M52.ToString(formatProvider),
			                     M53.ToString(formatProvider), M54.ToString(formatProvider));
		}
		...
		{
			return (MathUtils.NearEqual(other.M11, M11) &&
			        MathUtils.NearEqual(other.M12, M12) &&
			        MathUtils.NearEqual(other.M13, M13) &&
			        MathUtils.NearEqual(other.M14, M14) &&
			        MathUtils.NearEqual(other.M21, M21) &&
			        MathUtils.NearEqual(other.M22, M22) &&
			        MathUtils.NearEqual(other.M23, M23) &&
			        MathUtils.NearEqual(other.M24, M24) &&
			        MathUtils.NearEqual(other.M31, M31) &&
			        MathUtils.NearEqual(other.M32, M32) &&
			        MathUtils.NearEqual(other.M33, M33) &&
			        MathUtils.NearEqual(other.M34, M34) &&
			        MathUtils.NearEqual(other.M41, M41) &&
			        MathUtils.NearEqual(other.M42, M42) &&
			        MathUtils.NearEqual(other.M43, M43) &&
			        MathUtils.NearEqual(other.M44, M44) &&
			        MathUtils.NearEqual(other.M51, M51) &&
			        MathUtils.NearEqual(other.M52, M52) &&
			        MathUtils.NearEqual(other.M53, M53) &&
			        MathUtils.NearEqual(other.M54, M54));
		}
