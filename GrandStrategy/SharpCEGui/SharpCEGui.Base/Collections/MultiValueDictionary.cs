...
namespace SharpCEGui.Base.Collections
{
    /// <summary>
    ...
    public class MultiValueDictionary<TKey, TValue> : Dictionary<TKey, HashSet<TValue>>
    {
        ...
        /// This method is useful if you want to avoid an exception for key value retrieval 
        /// and you can't use TryGetValue (e.g. in lambdas)
        /// </summary>
        /// <param name="key">The key.</param>
        /// <param name="returnEmptySet">
        /// if set to true and the key isn't found, an empty hashset is returned, 
        /// otherwise, if the key isn't found, null is returned</param>
        /// <returns>
        /// This method will return null (or an empty set if returnEmptySet is true) 
        /// if the key wasn't found, or the values if key was found.
        /// </returns>
